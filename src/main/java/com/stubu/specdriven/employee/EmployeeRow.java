 ...
 *
 * @param regionName  the region whose public holidays apply to the employee (UC-017)
...
public record EmployeeRow(long id, String email, String firstName, String lastName, Role role, long departmentId,
        String departmentName, long regionId, String regionName, Long managerId, String managerName, boolean active,
        Instant createdAt, Instant lastLoginAt, long version) {
