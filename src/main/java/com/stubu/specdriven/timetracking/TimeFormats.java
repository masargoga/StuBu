...
final class TimeFormats {
    ...
    static String time(Instant instant, ZoneId zone, Locale locale) {
    ...
    static String timeOrDateTime(Instant instant, ZoneId zone, Locale locale, LocalDate reference) {
    ...
    static String fullDate(LocalDate date, Locale locale) {
