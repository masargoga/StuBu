...
> **Revision (UC-017):** The employee form has a required "Region" selection (a new employee starts with the first region); the audit entry of a change contains the old and new region.
