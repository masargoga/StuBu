 ...
 *
 * @param regionName     the region of the employee whose public holidays are marked (UC-017)
 ...
 */
public record MonthlyTimesheet(YearMonth period, String regionName, TimesheetStatus status, Instant submittedAt,
        Instant approvedAt, String approvedByName, Instant rejectedAt, String rejectionReason, List<DayLine> days,
